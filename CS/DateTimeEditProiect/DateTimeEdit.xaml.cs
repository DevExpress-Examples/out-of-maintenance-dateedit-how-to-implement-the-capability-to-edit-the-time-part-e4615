...
namespace DateTimeEditProiect {
    ...
    public partial class DateTimeEdit : DateEdit, INotifyPropertyChanged {
        ...
        public void SetDate(DateTime date) {
            this.DateTime = date.Date + new TimeSpan(RealHour, Minute, Second);
 ...
 EditStrategy.SetDateTime(this.DateTime.Date + new TimeSpan(RealHour, Minute, Second), new UpdateEditorSource());
            if(this.Calendar != null)
              {//  this.Calendar.SetNewDateTime(DateTime);
   this.Calendar.DateTime = DateTime;
    ...
    public class DateEditCalendarEx : DateEditCalendar {
        protected override void OnDayCellButtonClick(System.Windows.Controls.Button button) {
            ...
            var editor = OwnerDateEdit as DateTimeEdit;

            if(!editor.IsReadOnly)
                editor.SetDate((DateTime)DateEditCalendar.GetDateTime(button));
