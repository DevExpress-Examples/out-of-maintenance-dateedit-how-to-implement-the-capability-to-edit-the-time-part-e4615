...
Namespace DateTimeEditProiect
    ...
    Partial Public Class DateTimeEdit
        ...
        Public Sub SetDate(ByVal [date] As Date)
            Me.DateTime = [date].Date + New TimeSpan(RealHour, Minute, Second)
 ...
 EditStrategy.SetDateTime(Me.DateTime.Date + New TimeSpan(RealHour, Minute, Second), New UpdateEditorSource())
            If Me.Calendar IsNot Nothing Then
   Me.Calendar.DateTime = DateTime
            End If
        End Sub
        ...
        Private Sub OnTimeFormatChanged(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If value = enumTimeFormat.Auto Then
                ...
                If df.ShortTimePattern.Chars(0) = "H"c Then
    ...
    Public Class TimeFormatToVisibleConverter
        ...
        Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.Convert
            Dim tf As enumTimeFormat = DirectCast(value, enumTimeFormat)
    ...
    Public Class DateEditCalendarEx
        ...
        Protected Overrides Sub OnDayCellButtonClick(ByVal button As System.Windows.Controls.Button)
            ...
            Dim editor = TryCast(OwnerDateEdit, DateTimeEdit)

            If Not editor.IsReadOnly Then
                editor.SetDate(CDate(DateEditCalendar.GetDateTime(button)))
            End If
